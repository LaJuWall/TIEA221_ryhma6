...
class PohjaContent(BoxLayout):
    ...
    def on_close_button_clicked(self):
        if self.myparent.myparent.aanet:
            self.myparent.myparent.biip.play()
...
class VaaraPopup(Popup):
    ...
    def lopetaPeli(self):
    	if self.myparent.aanet:
            self.myparent.biip.play()
        sys.exit()
...
class MonitoriPeli(FloatLayout):
    ...
    biip = SoundLoader.load('bliip.wav')
    if not biip:
        print("EI SE AANI TOIMI!!!")
...
class Menuu(FloatLayout):
    def __init__(self, parent):
        ...
        self.myparent = parent
        self.sound = SoundLoader.load('bliip.wav')
        if not self.sound:
            print("EI SE AANI TOIMI!!!")
